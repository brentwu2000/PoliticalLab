        ...
        <div className="bg-slate-900/90 border border-emerald-500/30 rounded-2xl p-6 shadow-xl">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-bold text-emerald-400">{partyLabelA}｜民進黨 論證樹 ({filteredA.length})</h3>
            </div>
          ...
          <div className="mt-6 space-y-4">
            {filteredA.map(node => (
              <div
                key={node.id}
                className="bg-slate-950/60 border border-slate-800 hover:border-emerald-500/40 p-4 rounded-xl transition-all"
              >
        ...
        <div className="bg-slate-900/90 border border-blue-500/30 rounded-2xl p-6 shadow-xl">
          <div className="flex items-center justify-between pb-4 border-b border-slate-800">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-bold text-blue-400">{partyLabelB}｜國民黨 論證樹 ({filteredB.length})</h3>
            </div>
            <span className="text-xs font-mono text-slate-400">
              上限: 最多使用 2 次/核心
            </span>
